...
#
# Examples:
#   scripts/sync-agent-notice.sh <profiles>/alpha/claude-home/CLAUDE.md
#   scripts/sync-agent-notice.sh <profiles>/alpha/gemini-home/config/rules/sandbox-notice.md
