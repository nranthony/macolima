...
# Mirrors scripts/profile.sh: DRIVE="${SANDBOX_DRIVE:-/Volumes/DataDrive}".
DRIVE = Path(os.environ.get("SANDBOX_DRIVE", "/Volumes/DataDrive"))
DEFAULT_PROFILES_DIR = DRIVE / ".claude-colima" / "profiles"
DEFAULT_WORKSPACES_ROOT = DRIVE / "repo"
...
HOST_PATH_RE = re.compile(r"/Volumes/|/Users/|/home/(?!agent/)")
