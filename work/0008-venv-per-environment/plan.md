...
| 7 | **Conventions release** (handoff-depot T1–T4, runs any time from now), then the remaining repos' handoffs cite its ADR | depot agent; me | myconv 0.9.0 published and re-vendored |
