...
**State:** stages 0–7 done 2026-09-14; the done-check exits 0. Open: stage 8 (replay ferried, machines report back) and stage 9 (retire `depot/myclickup/.venv` after a soak). **Opened:** 2026-09-11.
