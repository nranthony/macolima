...
| [0015](0015-the-sandbox-briefs-agents-from-their-homes.md) | The sandbox briefs agents from their global homes, never from a repo |
...
0013 and 0015 are shared with the sibling by intent: its copy of the same
decision takes the same number. **0014 is reserved** by `work/0010`
(paperbridge delivery) and lands with it. New decisions here continue from
**0016**.
